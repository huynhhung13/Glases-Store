<?php
    ...
    AND tbl_products.brand_id ='$_GET[id]' 
	AND tbl_products.product_active = 1
	ORDER BY tbl_products.brand_id DESC");
    $sql_brand = mysqli_query($con, "SELECT * FROM tbl_brands WHERE brand_id ='$_GET[id]' LIMIT 1");
    $row_brand = mysqli_fetch_array($sql_brand);
...
?>
	...
	<div class="col-md-12 product-block"><h2 class="text-center"><?php echo $row_brand['brand_name'] ?></h2></br>
	<?php while($row_product = mysqli_fetch_array($sql_product)) {?>
		...
		<div class="home-product-main">
			...
			<div class="home-product-bottom text-center">
				<h3 style="text-align: left!important;"><a href="shop.php?header=product&id=<?php echo $row_product['brand_id'] ?>"><?php echo $row_product['brand_name'] ?></a></h3>
